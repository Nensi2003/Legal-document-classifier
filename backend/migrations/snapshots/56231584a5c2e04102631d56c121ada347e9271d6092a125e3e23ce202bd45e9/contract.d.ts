...
export type StorageHash =
  StorageHashBase<'56231584a5c2e04102631d56c121ada347e9271d6092a125e3e23ce202bd45e9'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly DocumentInstance: {
      ...
      readonly endPage: CodecTypes['pg/int4@1']['output'];
      readonly detectionMethod: CodecTypes['pg/text@1']['output'] | null;
      readonly detectionScore: CodecTypes['pg/int4@1']['output'] | null;
      readonly extractedText: CodecTypes['pg/text@1']['output'] | null;
      readonly status: CodecTypes['pg/text@1']['output'];
      readonly draftData: CodecTypes['pg/json@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly DocumentInstance: {
      ...
      readonly endPage: CodecTypes['pg/int4@1']['input'];
      readonly detectionMethod: CodecTypes['pg/text@1']['input'] | null;
      readonly detectionScore: CodecTypes['pg/int4@1']['input'] | null;
      readonly extractedText: CodecTypes['pg/text@1']['input'] | null;
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly draftData: CodecTypes['pg/json@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            readonly batch: {
              ...
              indexes: readonly [
                {
                  readonly name: 'batch_userId_idx_a489d58a';
                  readonly prefix: 'batch_userId_idx';
            ...
            readonly document: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'document_batchId_idx_84d4b0b9';
                  readonly prefix: 'document_batchId_idx';
            ...
            readonly documentInstance: {
              ...
              indexes: readonly [
                {
                  readonly name: 'documentInstance_documentId_idx_825ef746';
                  readonly prefix: 'documentInstance_documentId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'documentInstance';
                    readonly columns: readonly ['documentId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly documentInstance: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'DocumentInstance';
    };
  };
  readonly domain: {
    readonly namespaces: {
          ...
          readonly Document: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly draftData: { readonly column: 'draftData' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          ...
          readonly DocumentInstance: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly startPage: { readonly column: 'startPage' };
                readonly endPage: { readonly column: 'endPage' };
                readonly detectionMethod: { readonly column: 'detectionMethod' };
                readonly detectionScore: { readonly column: 'detectionScore' };
                readonly extractedText: { readonly column: 'extractedText' };
                readonly status: { readonly column: 'status' };
                readonly draftData: { readonly column: 'draftData' };
                readonly generatedJSON: { readonly column: 'generatedJSON' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
